            ...
            <div class="grid-container">
                ...
                <div class="grid-70 prefix-15 mobile-grid-100 tablet-grid-100">
                    ...
                    <span class="copyright">
                        <?php _e('Copyright 2015 de Mujeres de las Américas'); ?>
                    </span>


 <div id="footermenu" align="center">
                            <ul id="menu-menu-footer" class="footermenu"><li id="menu-item-2852" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2852"><a href="http://www.mujeresdelasamericas.com/aviso-de-privacidad/">Aviso de Privacidad</a></li>
</ul>                        </div> 
